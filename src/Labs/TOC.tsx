...
export default function TOC() {
    ...
    return (
        <ul className="nav nav-pills" id="wd-toc">
            ...
            <li className="nav-item"><a id="wd-github-react" href="https://github.com/jingyi1211/kanbas-react-web-app" target="_blank"
                className="nav-link">React Web App on Github</a></li>
            <li className="nav-item"><a id="wd-github-node" href="https://github.com/jingyi1211/kanbas-node-server-app" target="_blank"
                className="nav-link">Node Sever App on Github</a></li>
            <li className="nav-item"><a id="wd-render" href="https://kanbas-node-server-app-lcub.onrender.com" target="_blank"
                className="nav-link">Node Sever App on Render</a></li>
        </ul>
    );
}
